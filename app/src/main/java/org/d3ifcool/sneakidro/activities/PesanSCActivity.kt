...
import org.d3ifcool.sneakidro.databinding.ActivityPesanScBinding

class PesanSCActivity : AppCompatActivity() {
    ...
    private lateinit var binding: ActivityPesanScBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityPesanScBinding.inflate(layoutInflater)
        ...
        binding.pesanBtn.setOnClickListener {
            ...
            if (selectedId1 == -1 || jenisSepatu.isEmpty() ||
                ...
                val kategori = if (binding.softClean.isChecked) SOFT_CLEANING else DEEP_CLEANING
